...
/**
 * Tests for the MultiMoveFreecellModel class.
 */
public class MultiMoveFreecellModelTests {
  ...
  List<ICard> deck3 = new MultiMoveFreecellModel().getDeck();
  cs3500.freecell.model.hw04.MultiMoveFreecellModel game = new MultiMoveFreecellModel();

  @Test
  public void testGetDeck() {
    assertEquals(new MultiMoveFreecellModel().getDeck().toString(),
        new StringBuilder()
  ...
  public void testStartGameTooManyCardsInDeck() {
    deck.add(card1);
    new MultiMoveFreecellModel().startGame(deck, 8, 4, false);
  }
  ...
  public void testStartGameEmptyDeck() {
    new MultiMoveFreecellModel().startGame(deck2, 8, 4, false);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testStartGameDeckIsNull() {
    new MultiMoveFreecellModel().startGame(null, 8, 4, false);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testStartGameLessThan4Cascade() {
    new MultiMoveFreecellModel().startGame(deck, 3, 4, false);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testStartGameLessThan1Open() {
    new MultiMoveFreecellModel().startGame(deck, 8, 0, false);
  }
  ...
  public void testStartGameDeckShuffleTrue() {
    ...
    new MultiMoveFreecellModel().startGame(deck, 8, 4, true);
  ...
  // start of added tests for hw 4
  @Test
  public void testMultiMove() {
    game.startGame(deck, 52, 4, false);
    game.move(PileType.CASCADE, 0, 0, PileType.CASCADE, 5);
    game.move(PileType.CASCADE, 5, 0, PileType.CASCADE, 8);
    assertEquals(game.getCascadeCardAt(8, 0).toString(), "3♣");
    assertEquals(game.getCascadeCardAt(8, 1).toString(), "2♦");
    assertEquals(game.getCascadeCardAt(8, 2).toString(), "A♣");
  }

  @Test
  public void testMultiMove3Cards() {
    game.startGame(deck, 52, 4, false);
    game.move(PileType.CASCADE, 0, 0, PileType.CASCADE, 5);
    game.move(PileType.CASCADE, 5, 0, PileType.CASCADE, 8);
    game.move(PileType.CASCADE, 8, 0, PileType.CASCADE, 13);
    assertEquals(game.getCascadeCardAt(13, 1).toString(), "3♣");
    assertEquals(game.getCascadeCardAt(13, 2).toString(), "2♦");
    assertEquals(game.getCascadeCardAt(13, 3).toString(), "A♣");
    assertEquals(game.getCascadeCardAt(13, 0).toString(), "4♦");
  }

  @Test
  public void testMultiMove4Cards() {
    game.startGame(deck, 52, 4, false);
    game.move(PileType.CASCADE, 0, 0, PileType.CASCADE, 5);
    game.move(PileType.CASCADE, 5, 0, PileType.CASCADE, 8);
    game.move(PileType.CASCADE, 8, 0, PileType.CASCADE, 13);
    game.move(PileType.CASCADE, 13, 0, PileType.CASCADE, 16);
    assertEquals(game.getCascadeCardAt(16, 2).toString(), "3♣");
    assertEquals(game.getCascadeCardAt(16, 3).toString(), "2♦");
    assertEquals(game.getCascadeCardAt(16, 4).toString(), "A♣");
    assertEquals(game.getCascadeCardAt(16, 1).toString(), "4♦");
    assertEquals(game.getCascadeCardAt(16, 0).toString(), "5♣");
  }
  ...
  public void illegalBuildColorMultiMovingValidStack() {
    game.startGame(deck, 52, 4, false);
    game.move(PileType.CASCADE, 0, 0, PileType.CASCADE, 5);
    game.move(PileType.CASCADE, 5, 0, PileType.CASCADE, 9);
  }
  ...
  public void illegalBuildRankMultiMovingValidStack() {
    game.startGame(deck, 52, 4, false);
    game.move(PileType.CASCADE, 0, 0, PileType.CASCADE, 5);
    game.move(PileType.CASCADE, 5, 0, PileType.CASCADE, 15);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testMovingIllegalStackColor() {
    Collections.reverse(deck);
    game.startGame(deck, 4, 16, false);

    // clearing the first cascade pile so I can attempt a multi move
    game.move(PileType.CASCADE, 0, 12, PileType.OPEN, 0);
    game.move(PileType.CASCADE, 0, 11, PileType.OPEN, 1);
    game.move(PileType.CASCADE, 0, 10, PileType.OPEN, 2);
    game.move(PileType.CASCADE, 0, 9, PileType.OPEN, 3);
    game.move(PileType.CASCADE, 0, 8, PileType.OPEN, 4);
    game.move(PileType.CASCADE, 0, 7, PileType.OPEN, 5);
    game.move(PileType.CASCADE, 0, 6, PileType.OPEN, 6);
    game.move(PileType.CASCADE, 0, 5, PileType.OPEN, 7);
    game.move(PileType.CASCADE, 0, 4, PileType.OPEN, 8);
    game.move(PileType.CASCADE, 0, 3, PileType.OPEN, 9);
    game.move(PileType.CASCADE, 0, 2, PileType.OPEN, 10);
    game.move(PileType.CASCADE, 0, 1, PileType.OPEN, 11);
    game.move(PileType.CASCADE, 0, 0, PileType.OPEN, 12);

    // multi move (correct values for build but incorrect color)
    game.move(PileType.CASCADE, 1, 11, PileType.CASCADE, 0);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testMovingIllegalStackRank() {
    Collections.reverse(deck);
    game.startGame(deck, 6, 16, false);
    ...
    // multi move (incorrect value order)
    game.move(PileType.CASCADE, 1, 7, PileType.CASCADE, 0);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testMultiMoveTooManyCardsNotEnoughOpenPiles() {
    Collections.reverse(deck);
    game.startGame(deck, 4, 13, false);
    ...
    game.move(PileType.CASCADE, 0, 2, PileType.OPEN, 10);
    game.move(PileType.CASCADE, 0, 1, PileType.OPEN, 11);
    game.move(PileType.CASCADE, 1, 12, PileType.OPEN, 12);
    game.move(PileType.OPEN, 0, 0, PileType.CASCADE, 1);
    game.move(PileType.CASCADE, 0, 0, PileType.OPEN, 0);
    game.move(PileType.CASCADE, 3, 12, PileType.FOUNDATION, 0);
    game.move(PileType.CASCADE, 3, 11, PileType.FOUNDATION, 0);
    game.move(PileType.CASCADE, 3, 10, PileType.CASCADE, 0);

    // multi move (too many cards moving, not enough empty piles, theres 0 empty piles and
    // trying to move 2 cards)
    game.move(PileType.CASCADE, 1, 11, PileType.CASCADE, 0);
  }
  // end of added tests for hw 4
